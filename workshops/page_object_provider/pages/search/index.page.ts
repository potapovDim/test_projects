...
import {SearchFragment2, SearchFragment1} from './fragments'

interface SearchInterface {
  setSearch(): Promise<void>;
  getSearch(): Promise<void>;
  logSearch(): Promise<any>;
}

class SearchPage {

  fragment1: SearchFragment1
  ...
  constructor() {
    this.fragment1 = new SearchFragment1()
    this.fragment2 = new SearchFragment2()
